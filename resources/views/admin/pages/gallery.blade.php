        ...
        <div class="col-sm-12">
            <ol class="float-sm-right">
                <button type="button" class="btn btn-block bg-gradient-primary" data-toggle="modal"
                    onclick="open_modal();"><i class="nav-icon fas fa fa-plus "></i> Add Image</button>
            </ol>
...
@include('modal.gallery_modal')
<script type="text/javascript">
    function open_modal() {
        document.getElementById("add_gallery").style.display = "block";
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        if (data == "") {
                            ...
                            var image = '{{ URL::to('/') }}' + '/gallery_image/' + data;
    ...
    //     get_data('show', gallery_id);
    // }

    // function update_hotel( gallery_id) {

    //     get_data('update',gallery_id);
    // }

    // function get_data(type, gallery_id) {
